<?php
    ...
    $count = $counts->fetch();
    $resources = $name->my_resources($_SESSION['tipo_user'],4);
    $veri = $name->my_resources($_SESSION['tipo_user'],4);
    $verify = $veri->fetch();
    //var_dump($count);
?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><i class="badge bg-danger rounded-pill">Removido (code <?php echo $lista[4]; ?>)</i></td>
                                    <?php 
                                        if($lista[5] == 'Docx.'){
                                            $icon = 'word';
                                        }else if($lista[5] == 'PDF.'){
