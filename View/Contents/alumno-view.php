...
<section class="content header_main">
  <div class="container header" style="">
    ...
    <div class="action-btns">
      ...
      <div class="col" style="display:inline-flex;"><a href="#" class="btn_user icon-menu" id="btn-menu" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"></a></div>
